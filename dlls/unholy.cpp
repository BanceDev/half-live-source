...
CHalfLifeUnholy::CHalfLifeUnholy()
{
}

//=========================================================
//=========================================================
void CHalfLifeUnholy::RefreshSkillData()
{
...
//=========================================================
//=========================================================
bool CHalfLifeUnholy::IsAllowedToSpawn(CBaseEntity* pEntity)
{
...
//=========================================================
//=========================================================
void CHalfLifeUnholy::PlayerThink(CBasePlayer* pPlayer)
{
	if (g_fGameOver)
	{
    ...
    pPlayer->GiveAmmo(100, "rockets", ROCKET_MAX_CARRY);
}

//=========================================================
//=========================================================
void CHalfLifeUnholy::PlayerSpawn(CBasePlayer* pPlayer)
{
	bool addDefault;
...
//=========================================================
//=========================================================
int CHalfLifeUnholy::DeadPlayerWeapons(CBasePlayer* pPlayer)
{
	return 0;
}
...
//=========================================================
//=========================================================
int CHalfLifeUnholy::DeadPlayerAmmo(CBasePlayer* pPlayer)
{
	return 0;
}
