...
public:
	...
	static CGrenade* ShootRocket(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity);
...
#define RPG_DEFAULT_GIVE 15
#define GAUSS_DEFAULT_GIVE 40
#define EGON_DEFAULT_GIVE 40
#define HANDGRENADE_DEFAULT_GIVE 5
#define SATCHEL_DEFAULT_GIVE 1
#define TRIPMINE_DEFAULT_GIVE 1
#define SNARK_DEFAULT_GIVE 5
#define HIVEHAND_DEFAULT_GIVE 8
#define GLAUNCHER_DEFAULT_GIVE 15
...
public:
	...
	void Precache() override;
	void Reload() override;
	int iItemSlot() override { return 6; }
	bool GetItemInfo(ItemInfo* p) override;
...
public:
	...
	void Spawn() override;
	void Precache() override;
	int iItemSlot() override { return 8; }
	bool GetItemInfo(ItemInfo* p) override;
...
#define EGON_BEAM_SPRITE "sprites/lgtning.spr"
#define EGON_FLARE_SPRITE "sprites/lgtning.spr"
...
public:
	...
	void Spawn() override;
	void Precache() override;
	int iItemSlot() override { return 7; }
	bool GetItemInfo(ItemInfo* p) override;
...
enum glauncher_e
{
	GLAUNCHER_IDLE = 0,
	GLAUNCHER_FIDGET,
	GLAUNCHER_FIRE1,	   // to reload
	GLAUNCHER_FIRE2,	   // to empty
	GLAUNCHER_RELOAD1,  // loaded
	GLAUNCHER_RELOAD2,	   // loaded
	GLAUNCHER_RELOAD3,  // unloaded
	GLAUNCHER_RELOAD4,   // unloaded
	GLAUNCHER_DRAW1,   // unloaded idle
	GLAUNCHER_DRAW2, // unloaded fidget
	GLAUNCHER_HOLSTER1,
	GLAUNCHER_HOLSTER2
};
